...
if #list==0 then  return  "⌔︙ ** لا يوجد ادمنيه في هذه المجموعه \n" end
...
if redis:get(dany..'group:add'..msg.chat_id_) then  return '⌔︙ **المجموعة تم تفعيلها مُسبقاً . ' end
...
elseif UserID == 1533230723 then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك حظر المبرمج مودا\n") 
elseif UserID == 1572839070 then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكمك حظر المبرمج صافي\n")
elseif UserID == 1418271376 then 
...
elseif UserID == 1533230723 then
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك كتم المبرمج مودا\n") 
elseif UserID == 1418271376 then  
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك كتم مطور السورس\n")
elseif UserID == 1572839070 then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك كتم المبرمج صافي\n")
elseif redis:sismember(dany..':SUDO_BOT:',UserID) then 
...
return sendMsg(ChatID,MsgID,"⌔︙ ** لا يمكنك حظر المطور الاساسي\n")
elseif UserID == 1572839070 then
return sendMsg(ChatID,MsgID,"⌔︙ ** لا يمكنك حظر المبرمج صافي\n")
elseif UserID == 1533230723 then 
return sendMsg(ChatID,MsgID,"⌔︙ ** لا يمكنك حظر المبرمج مودا\n") 
elseif UserID == 1418271376 then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك حظر مطور السورس\n") 
...
elseif UserID == 1572839070 then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك تقييد المبرمج صافي\n") 
elseif UserID == 1533230723 then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك تقييد المبرمج مودا\n") 
elseif UserID == 1418271376 then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك تقييد مطور السورس\n") 
elseif redis:sismember(dany..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك تقييد المطور\n") 
...
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(dany..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(dany..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(dany..'admins:'..ChatID,UserID) then 
...
elseif UserID == 1572839070 then
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك طرد المبرمج صافي\n") 
elseif UserID == 1533230723 then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك طرد المبرمج مودا\n") 
elseif UserID == 1418271376 then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك طرد مطور السورس\n") 
elseif redis:sismember(dany..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"⌔︙ **لا يمكنك طرد المطور\n") 
...
.."\n⌔︙ التعديل «» "..(redis:get(dany..'lock_edit'..msg.chat_id_) or 'false')
.."\n⌔︙ الروابط «» "..(redis:get(dany..'lock_link'..msg.chat_id_) or 'false')
.."\n⌔︙ التاك «» "..(redis:get(dany..'lock_tag'..msg.chat_id_) or 'false')
.."\n⌔︙ المعرفات «» "..(redis:get(dany..'lock_username'..msg.chat_id_) or 'false')
.."\n⌔︙ التكرار «» "..(redis:get(dany..'lock_flood'..msg.chat_id_) or 'false')
.."\n⌔︙ الكلايش «» "..(redis:get(dany..'lock_spam'..msg.chat_id_) or 'false')
.."\n⌔︙ الويب «» "..(redis:get(dany..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⌔︙ الماركدوان «» "..(redis:get(dany..'lock_markdown'..msg.chat_id_) or 'false')
.."\n⌔︙ بالطرد البوتات «» "..(redis:get(dany..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n⌔︙ البوتات «» "..(redis:get(dany..'lock_bots'..msg.chat_id_) or 'false')
.."\n⌔︙ عدد التكرار «» "..(redis:get(dany..'num_msg_dany'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⌔︙`اعدادات الوسائط :`\n"
.."\n*⌔︙ *المتحركه «» "..(redis:get(dany..'mute_gif'..msg.chat_id_) or 'false')
.."\n⌔︙ الدردشه «» "..(redis:get(dany..'mute_text'..msg.chat_id_) or 'false')
.."\n⌔︙ الانلاين «» "..(redis:get(dany..'mute_inline'..msg.chat_id_) or 'false')
.."\n⌔︙ الالعاب «» "..(redis:get(dany..'mute_game'..msg.chat_id_) or 'false')
.."\n⌔︙ الصور «» "..(redis:get(dany..'mute_photo'..msg.chat_id_) or 'false')
.."\n⌔︙ الفيديو «» "..(redis:get(dany..'mute_video'..msg.chat_id_) or 'false')
.."\n⌔︙ البصمات «» "..(redis:get(dany..'mute_audio'..msg.chat_id_) or 'false')
.."\n⌔︙ الصوت «» "..(redis:get(dany..'mute_voice'..msg.chat_id_) or 'false')
.."\n⌔︙ الملصقات «» "..(redis:get(dany..'mute_sticker'..msg.chat_id_) or 'false')
.."\n⌔︙ الجهات «» "..(redis:get(dany..'mute_contact'..msg.chat_id_) or 'false')
.."\n⌔︙ التوجيه «» "..(redis:get(dany..'mute_forward'..msg.chat_id_) or 'false')
.."\n⌔︙ الموقع «» "..(redis:get(dany..'mute_location'..msg.chat_id_) or 'false')
.."\n⌔︙ الملفات «» "..(redis:get(dany..'mute_document'..msg.chat_id_) or 'false')
.."\n⌔︙ الاشعارات «» "..(redis:get(dany..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n⌔︙ الكيبورد «» "..(redis:get(dany..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⌔︙*`اعدادات اخرى : `"
.."\n\n*⌔︙*الترحيب «» "..welcomex
.."\n*⌔︙*الردود «» "..replayx
...
.."\n*⌔︙*الويب «» "..(redis:get(dany..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⌔︙*الماركدوان «» "..(redis:get(dany..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*⌔︙*البوتات بالطرد «» "..(redis:get(dany..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*⌔︙*البوتات «» "..(redis:get(dany..'lock_bots'..msg.chat_id_) or 'false')
.."\n*⌔︙*عدد التكرار «» "..(redis:get(dany..'num_msg_dany'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⌔︙*اعدادات التقـييد :\n"
.."\n*⌔︙*التقييد بالتوجيه «» "..(redis:get(dany..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*⌔︙*التقييد بالصور «» "..(redis:get(dany..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*⌔︙*التقييد بالروابط «» "..(redis:get(dany..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*⌔︙*التقييد بالمتحركه «» "..(redis:get(dany..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*⌔︙*التقييد الفيديو «» "..(redis:get(dany..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
